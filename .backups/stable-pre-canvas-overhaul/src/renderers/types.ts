export type RenderMode = 'canvas-mesh' | 'svg-wavy';

export type PresetId = 'itonics-neutral' | 'neon' | 'dark';

export type CanvasShapeStyle = 'mesh' | 'center' | 'orbit' | 'particles' | 'opera-dust';

export type SvgShapeStyle = 'waves' | 'center' | 'rings';

export type ShapeStyle = CanvasShapeStyle | SvgShapeStyle;
